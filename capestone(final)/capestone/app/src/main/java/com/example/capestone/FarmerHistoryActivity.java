...
public class FarmerHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(FarmerHistoryActivity.this, FarmerHomeActivity.class);
        ...
        loadFarmerHistory(userId); // Load the history for the logged-in farmer
    }

    private void loadFarmerHistory(String userId) {
        Cursor cursor = dbHelper.getHistory(userId); // Fetch history for the user
